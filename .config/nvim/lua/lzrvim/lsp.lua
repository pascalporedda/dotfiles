...
local function lsp_config(_config)
    return vim.tbl_deep_extend("force", {
        ...
        on_attach = function()
            ...
            key_mapper.n_noremap_silent("gr",
                                        "<cmd>lua require('telescope.builtin').lsp_references()<CR>")
            key_mapper.n_noremap_silent("go",
                                        "<cmd>lua require('telescope.builtin').lsp_dynamic_workspace_symbols()<CR>")
            key_mapper.n_noremap_silent("gi",
            ...
            key_mapper.v_noremap_silent("<leader>ca",
                                        "<cmd><C-U>lua vim.lsp.buf.code_action()<CR>")
...
local snippets_paths = function()
    local plugins = {"friendly-snippets", "awesome-flutter-snippets"}
    local paths = {}
    local path
